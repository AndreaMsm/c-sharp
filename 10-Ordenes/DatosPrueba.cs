...
public class DatosPrueba
{
    ...
    private void CargarProducto(){
        ...
        Producto p3=new Producto (003,"Monitor",3500);
        ListaProductos.Add(p3);
        Producto p4=new Producto (004,"Headset",1400);
        ListaProductos.Add(p4);
        Producto p5=new Producto (005,"Lapto DELL",19000);
    ...
    {
        Cliente c1=new Cliente (001,"Jhessua","2560-3460",900);
        ListaClientes.Add(c1);
        Cliente  c2=new Cliente (002,"Rubi","2674-2301",500);
        ListaClientes.Add(c2);
        Cliente  c3=new Cliente (003,"Denilson","3324-5589",1500);
    ...
    {
        Vendedor v1=new Vendedor (001,"Jader","v001");
        ListaVendedores.Add(v1);
        Vendedor  v2=new Vendedor (002,"Eduardo","v002");
        ListaVendedores.Add(v2);
        Vendedor  v3=new Vendedor (003,"Araque","v003");
